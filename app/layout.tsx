...
export const metadata = {
  title: "ChatGPT Your Files - Eco Edition",
  description: "Chat with your documents using sustainable AI",
};
      ...
      <body className="h-full">
        <Providers>
          <div className="flex flex-col items-center h-full">
            <nav className="w-full flex justify-center border-b border-primary/20">
              <div className="max-w-6xl flex grow justify-end items-center text-sm text-foreground">
                <div className="flex flex-row grow">
                  <Link
                    href="/"
                    className="py-4 px-6 cursor-pointer hover:bg-primary/10 font-bold transition-colors"
                  >
                    <svg
                      width="20px"
                      height="20px"
                ...
                <div className="flex flex-row">
                  {user ? (
                    ...
                    <Link
                      href="/login"
                      className="py-4 px-6 rounded-md no-underline bg-primary text-primary-foreground hover:bg-primary/90 transition-colors"
                    >
                      Login
                    </Link>
                  )}
